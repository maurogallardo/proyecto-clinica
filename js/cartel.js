...
// (o, si el cartel se puede cancelar, si toca afuera o aprieta Escape).
//
// Opciones:
...
function preguntar({
  titulo, texto = '', textoConfirmar = 'Aceptar', textoVolver = 'Volver', peligro = false,
  icono = null, columna = false, cancelable = true, enfocar = 'volver',
}) {
